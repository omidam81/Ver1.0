    ...
    public class AdminMessageController : Controller, IUpdateModel
    {
        ...
        public ActionResult Index()
        {
            ...
            var settings = _settingsService.GetSettingByCulture(cultureUsed).List().Select(s => new MailChimpListViewModel
            {
                ...
                CampaignNotReachGoalBuyerTemplate = System.IO.File.Exists(pathToTemplates + "not-reach-goal-buyer-template-" + cultureUsed + ".html") ? "not-reach-goal-seller-template-" + cultureUsed + ".html" : "No file!",
                CampaignNotReachGoalSellerTemplate = System.IO.File.Exists(pathToTemplates + "not-reach-goal-seller-template-" + cultureUsed + ".html") ? "not-reach-goal-buyer-template-" + cultureUsed + ".html" : "No file!",
                ...
                DefinitelyGoSellerTemplate = System.IO.File.Exists(pathToTemplates + "definitely-go-to-print-seller-template-" + cultureUsed + ".html") ? "definitely-go-to-print-seller-template-" + cultureUsed + ".html" : "No file!",
                DefinitelyGoBuyerTemplate = System.IO.File.Exists(pathToTemplates + "definitely-go-to-print-buyer-template-" + cultureUsed + ".html") ? "definitely-go-to-print-buyer-template-" + cultureUsed + ".html" : "No file!",
