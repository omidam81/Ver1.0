...
namespace Teeyoot.Messaging.Controllers
{
    ...
    public class AdminMessageContentController : Controller
    {
        ...
        public ActionResult SendSellerMessage(int messageId)
        {
            ...
            string messageText = TemplateContent.Template.Replace("---MessageContent---", message.Text);
            messageText = messageText.Replace("---SellerEmail---", "");
            messageText = messageText.Replace("---CampaignTitle---", "");
