            ...
            return "<li>" +
              "<div style = 'margin-top:45px; height:180px;' class='bootstrap-wysihtml5-insert-link-modal modal modWind'>" +
                "<div class='modal-header'>" +
                  ...
                  "<h3 style='font-size: initial;  margin-left:30px;   font-weight: bolder; height:30px;'>" + locale.link.insert + "</h3>" +
                "</div>" +
        ...
        "image": function (locale, options) {
            ...
            return "<li>" +
              "<div style = 'margin-top:45px; height:180px;' class='bootstrap-wysihtml5-insert-image-modal modal fade modWind'>" +
                "<div class='modal-header'>" +
                  "<a class='close' data-dismiss='modal'>&times;</a>" +
                  "<h3 style='font-size: initial; margin-left:30px;   font-weight: bolder; height:30px;'>" + locale.image.insert + "</h3>" +
                "</div>" +
                "<div class='modal-body'>" +
